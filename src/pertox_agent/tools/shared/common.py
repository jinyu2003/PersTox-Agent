...
ASS = {"Reaction_ID": 0, "Drug_ID": 1, "PubMed": 3, "Source": 4, "Case_number": 5,
       ...
       "priority": 18, "severity_grade": 20, "sex_dis": 21, "age_dis": 22}
# Stratified score tables (CCombined_Results_{route,form,INDI}_with_scores.txt).
# Drug_ID is the InChIKey; Reaction_ID is the ADE UMLS id (same as ASS).
ASS_ROUTE = {"Reaction_ID": 0, "Drug_ID": 1, "Route": 2, "Case_number": 4, "Odds_Ratio": 5,
             "PRR": 9, "ROR": 10, "ROR_Lower_CI": 11, "ROR_Upper_CI": 12, "total_score": 16,
             "priority": 17, "severity_grade": 19}
ASS_FORM = {"Reaction_ID": 0, "Drug_ID": 1, "Form": 2, "Case_number": 4, "Odds_Ratio": 5,
            "PRR": 9, "ROR": 10, "ROR_Lower_CI": 11, "ROR_Upper_CI": 12, "total_score": 16,
            "priority": 17, "severity_grade": 19}
ASS_INDI = {"INDI_ID": 0, "Reaction_ID": 1, "Drug_ID": 2, "Case_number": 3, "Odds_Ratio": 4,
            "PRR": 6, "ROR": 7, "ROR_Lower_CI": 8, "ROR_Upper_CI": 9, "total_score": 14,
            "priority": 15, "severity_grade": 17}
...
def api_get(url: str, params: Optional[dict] = None, *, cache_subdir: str,
    ...
    try:
        from pertox_agent.kb_builder.api_cache import cached_get
...
def api_post(url: str, json_body: dict, *, cache_subdir: str,
    ...
    try:
        from pertox_agent.kb_builder.api_cache import cached_post
